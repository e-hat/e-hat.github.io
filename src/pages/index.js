    ...
    <div className="website">
      <section>
          <article className="profile">
            ...
            <p className="bio-text">Also, I just accepted an offer at <a href="https://www.stellarscience.com/">Stellar Science</a> 🌠 as an intern for summer 2021, where I'll be writing tons of C++ and doing some cool science stuff.</p>
            ...
            <p className="bio-text">
                ...
                <ul>
                    ...
                    <li><code>onewknd</code> - My implementation of the <a href="https://raytracing.github.io/books/RayTracingInOneWeekend.html">ray-tracing in one weekend</a> tutorial (<a href="https://github.com/e-hat/onewknd">github</a>). I'm currently working on a <a href="https://github.com/e-hat/RayTracingOneWeekend-Haskell">rewrite in <code>Haskell</code></a> to flex my functional programming skills.</li>
            ...
            <p className="bio-text">I'm implementing a standard physically-based lighting model to my renderer at the moment, which requires using a new model loading library. Awesome.</p>
            <p className="bio-text">In the background, I'm doing some projects in Haskell and checking out programming languages/compiler design.</p>
